...
// Define blog posts directly in this file
$posts = [
    [
...
// Create simple text files as placeholders instead of generating images
$placeholderImages = [
...
foreach ($placeholderImages as $imageName) {
    ...
    if (!file_exists($imagePath)) {
        ...
        file_put_contents($imagePath, "Placeholder for $imageName");
        echo "Created placeholder file for: $imageName<br>";
    }
}

// Add function to functions.php if it doesn't exist
$functionsPath = 'includes/functions.php';
if (file_exists($functionsPath)) {
    $functionsContent = file_get_contents($functionsPath);
    
    // Check if getBlogPost function already exists
    if (strpos($functionsContent, 'function getBlogPost') === false) {
...
function getBlogPost($id) {
    ...
    return null;
        ...
        file_put_contents($functionsPath, $functionsContent . $newFunction);
        echo "Added getBlogPost function to functions.php<br>";
    } else {
        echo "getBlogPost function already exists in functions.php<br>";
    }
} else {
    echo "Warning: functions.php not found. Please add the getBlogPost function manually.<br>";
}

echo "<br><strong>Blog setup complete! 🚀</strong><br>";
echo "Next steps:<br>";
echo "1. Replace placeholder files in <strong>assets/images/blog/</strong> with real images<br>";
echo "2. Visit <a href='blog.php'>blog.php</a> to see your new blog!<br>";
?>